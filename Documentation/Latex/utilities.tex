...
Recommended usage: \texttt{btkImageInjection -i anat01.nii.gz $\cdots$ -i
anatN.nii.gz -m mask01.nii.gz $\cdots$ -m maskN.nii.gz -t transform01.txt $\cdots$ -t
transformN.txt -o anat\_reconstructed.nii.gz --mask}
...
\item[btkImageSubtract]: Pixel-wise subtraction of two image, or one image and a constant (-i anat01.nii.gz -i anat02.nii.gz -o substraction\_image.nii.gz or -i anat.nii.gz -c value -o substraction\_image.nii.gz) (ITK filter: SubtractImageFilter).
%------------------------------------------------------------------------------
\addcontentsline{toc}{subsection}{btkInverseDisplacementField}
\item[btkInverseDisplacementField]: Compute the inverse of a displacement field (-i field.nii.gz -o inverse\_field.nii.gz ) (ITK filter: InverseDisplacementFieldImageFilter).
%------------------------------------------------------------------------------
...
nrrd format (*.nhdr). Usage: \texttt{-i input.nii.gz -o output.nhdr}
...
Usage: \texttt{btkReorientDiffusionSequenceToStandard -i dwi.nii.gz -o dwi\_reoriented.nii.gz -l
landmarks.fcsv}.
...
Usage: \texttt{btkReorientImageToStandard -i anat.nii.gz -o anat\_reoriented.nii.gz -l landmarks.fcsv}.
