...
\item[btkApplyTransformationToImage]: Apply an ITK or BTK transformation on a image (old btkWarpTransformationToImage XXXXXXXX UNCLEAR XXXXXXXX).
%------------------------------------------------------------------------------
...
%------------------------------------------------------------------------------
\addcontentsline{toc}{subsection}{btkColorFiberTractsByMeanOrientation}
...
%------------------------------------------------------------------------------
\addcontentsline{toc}{subsection}{btkConvertFSLTransform}
\item[btkConvertFSLTransform]: Convert a FSL matrix to a ITK Affine Transform, specify $--inverse$ to do the opposite (ITK to FSL).
%------------------------------------------------------------------------------
...
\item[btkFSLToITKTransform]: XXXXXXXXXXXXXXXXXXXXXXXXXXX.
%------------------------------------------------------------------------------
...
\item[btkSimulateLowResolutionImage]: XXXXXXXXXXXXXXXXXXXXXXXXXXX.%------------------------------------------------------------------------------
...
\item[btkSimulateStandardViewsFromImage]: XXXXXXXXXXXXXXXXXXXXXXXXXXX.%------------------------------------------------------------------------------
